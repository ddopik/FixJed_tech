...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "AddAssets" : MessageLookupByLibrary.simpleMessage("إضافة قطع غيار"),
    ...
    "Assetsrequesthassuccessfullysent" : MessageLookupByLibrary.simpleMessage("تم إرسال قطع الغيار بنجاح"),
    ...
    "EditYourPersonalInfo" : MessageLookupByLibrary.simpleMessage("تعديل معلوماتك الشخصية"),
    "ForgotPassword" : MessageLookupByLibrary.simpleMessage("نسيت كلمه المرو"),
    "OrderHasCompletedSuccessfully" : MessageLookupByLibrary.simpleMessage("لقد إكتمل\nالطلب بنجاح"),
    "ProfileSetting" : MessageLookupByLibrary.simpleMessage("إعدادات الحساب"),
    ...
    "connectOperator" : MessageLookupByLibrary.simpleMessage("تواصل مع الاداره"),
    ...
    "customerAskedToCancel" : MessageLookupByLibrary.simpleMessage("العميل أراد ان يلغي"),
    "customerIsRude" : MessageLookupByLibrary.simpleMessage("العميل وقح"),
    "customerWasntAthome" : MessageLookupByLibrary.simpleMessage("العميل ليس بالمنزل"),
    ...
    "fixedAddressOne" : MessageLookupByLibrary.simpleMessage("التجمع الخامس"),
    "forgotPassword" : MessageLookupByLibrary.simpleMessage("نسيت كلمه المرور؟"),
    "havingProblemText_1" : MessageLookupByLibrary.simpleMessage("هل تواجه مشكلة في الحصول على المال؟ الاتصال بالاداره"),
    "help" : MessageLookupByLibrary.simpleMessage("مساعده"),
    "homeTitleDesc" : MessageLookupByLibrary.simpleMessage("اطلب الخدمات التي تريدها لتصل إلى منزلك في اسرع وقت"),
    ...
    "orderSubmission" : MessageLookupByLibrary.simpleMessage("تقديم \n الطلب"),
    "orders" : MessageLookupByLibrary.simpleMessage("طلب"),
    "othersAndIneedOneofOperationstoContactMe" : MessageLookupByLibrary.simpleMessage("أخرى و اريد ان أتحدث الي العاملين"),
    ...
    "pleaseSelectReason" : MessageLookupByLibrary.simpleMessage("برجاء اختيار سبب"),
