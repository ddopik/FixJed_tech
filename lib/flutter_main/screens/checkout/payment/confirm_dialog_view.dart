...
class ConfirmDialogView extends StatelessWidget {
  ...
  ConfirmDialogView({this.transActionAddress, this.onConfirm});
  ...
  renderView(BuildContext context) {
    return Container(
      ...
      children: [
                        ...
                        Expanded(
                            ...
                            child: Column(
                              ...
                              children: [
                                IconButton(
                                    padding:
                                        EdgeInsets.only(bottom: 22, left: 8),
                                    icon: Icon(
                                      Icons.edit,
                                      color: boring_green,
                                    ),
        ...
        (Provider.of<AppModel>(context).getUserPhone() != null)
            ? Column(
                children: [
                  Container(
                  ...
                  Container(
                    ...
                    child: Text(
                      Provider.of<AppModel>(context).getUserPhone().toString(),
                      style: TextStyle(
                        color: french_blue,
                        fontWeight: FontWeight.w400,
                        fontFamily: "Tajawal",
