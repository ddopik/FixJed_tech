...
class _MyHomePageState extends State<CalenderView> {
  ...
  DateTime _currentSelectedDate = DateTime(DateTime.now().year, DateTime.now().month, DateTime.now().day);
...
//       markedDatesMap: _markedDateMap,
      ...
      maxSelectedDate: DateTime(DateTime.now().year, DateTime.now().month, DateTime.now().day).add(Duration(days: 360)),
